...
#include "mylib/stb_image.h"

#define TINYOBJLOADER_IMPLEMENTATION
#include "mylib/tiny_obj_loader.h"
...
struct QueueFamilyIndices {
    nonstd::optional<uint32_t> graphicsFamily;
    nonstd::optional<uint32_t> presentFamily;
